...
const Context = struct {
    ...
    fn createTextureSampler(self: *Context) void {
        ...
        const sampler_info: c.VkSamplerCreateInfo = .{
            ...
            // .minLod = @floatFromInt(@divFloor(self.mip_levels, 2)), // test values
            .minLod = 0, // Optional
    ...
    fn generateMipmaps(self: *Context, image: c.VkImage, image_format: c.VkFormat, tex_width: i32, tex_height: i32, mip_levels: u32) void {
        ...
        var format_properties: c.VkFormatProperties = .{};
        ...
        if ((format_properties.optimalTilingFeatures & c.VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT) == 0) {
        ...
        for (1..mip_levels) |i| {
            ...
            var blit: c.VkImageBlit = .{
                ...
                .dstOffsets = .{
                    .{ .x = 0, .y = 0, .z = 0 },
                    .{
                        .x = if (mip_width > 1) @divFloor(mip_width, 2) else 1, // is floor ok?
                        .y = if (mip_height > 1) @divFloor(mip_height, 2) else 1, // is floor ok?
                        .z = 1,
                    },
                },
                .srcSubresource = .{
